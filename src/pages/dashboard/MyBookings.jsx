...
//   const fetchBookings = () => {
//     axios.get(`https://tourism-management-system-server.onrender.com/api/bookings/${user.email}`).then(res => {
...
//         axios.delete(`https://tourism-management-system-server.onrender.com/api/bookings/${id}`).then(() => {
//           fetchBookings();
...
const MyBookings = () => {
  ...
  const fetchBookings = () => {
    ...
    axios
      .get(`https://tourism-management-system-server.onrender.com/api/bookings/${user.id}`) // এখান থেকে সব bookings আসতে পারে
      .then((res) => {
